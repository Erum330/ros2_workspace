...
static const _IOTSensor_type_support_symbol_names_t _IOTSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, new_interfaces, msg, IOTSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, new_interfaces, msg, IOTSensor)),
  }
};
...
{
  return &::new_interfaces::msg::rosidl_typesupport_cpp::IOTSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, new_interfaces, msg, IOTSensor)() {
  return get_message_type_support_handle<new_interfaces::msg::IOTSensor>();
}
